This is some info that HMH may want to keep on the radar for future react/reduc projects. It's not recommoendations... just things to be aware of and further investigated if it seems like a good fit. 
